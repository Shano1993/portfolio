...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nhtml {\n  font-size: 62.5%;\n  font-family: \"Orbitron\", sans-serif;\n}\n\na {\n  text-decoration-line: none;\n  font-size: 1.8rem;\n}\n\nheader {\n  background-color: aliceblue;\n  padding: 1.5rem;\n  display: flex;\n  justify-content: space-around;\n  align-items: flex-end;\n  flex-wrap: wrap;\n}\nheader #logo {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: contain;\n  width: 15.3rem;\n  height: 5.4rem;\n}\nheader #menu a {\n  padding: 0.5rem 1.5rem;\n  margin: 0 1rem;\n  color: #004aad;\n}\nheader #menu a:hover {\n  color: #004aad;\n}\nheader #log a {\n  padding: 0.6rem 0.8rem;\n  margin: 0 0.5rem;\n  font-size: 1.4rem;\n}\nheader #log #login, header #log #register {\n  position: relative;\n  box-sizing: border-box;\n  text-decoration: none;\n  color: #004aad;\n}\nheader #log #login::before, header #log #login::after, header #log #register::before, header #log #register::after {\n  position: absolute;\n  display: block;\n  content: \"\";\n  width: 0;\n  border-top: 0.2rem solid #004aad;\n  transition-duration: 0.5s;\n}\nheader #log #login::before, header #log #register::before {\n  top: -0.2rem;\n  left: 0;\n}\nheader #log #login::after, header #log #register::after {\n  bottom: -0.3rem;\n  right: 0;\n}\nheader #log #login:hover, header #log #register:hover {\n  color: black;\n}\nheader #log #login:hover::before, header #log #login:hover::after, header #log #register:hover::before, header #log #register:hover::after {\n  width: 75%;\n}\n\n#home:hover, #skills:hover, #application:hover, #contact:hover {\n  color: transparent;\n  text-shadow: 0.2rem 0.2rem 1rem #004aad;\n  text-align: center;\n  animation: flicker 0.5s ease-in-out infinite alternate;\n}\n\n@keyframes flicker {\n  0% {\n    opacity: 0.5;\n    text-shadow: 0.2rem 0.2rem 1rem #004aad;\n  }\n  100% {\n    opacity: 1;\n    text-shadow: 0.2rem 0.2rem 1rem #004aad;\n  }\n}\n@media screen and (max-width: 1050px) {\n  #log {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    margin: 1rem;\n  }\n}\n@media screen and (max-width: 805px) {\n  header {\n    padding: 0.5rem;\n  }\n  #menu {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    margin: 1rem;\n  }\n}\n@media screen and (max-width: 600px) {\n  header {\n    flex-direction: column;\n    flex-wrap: nowrap;\n  }\n  #menu {\n    flex-direction: column;\n  }\n}", "",{"version":3,"sources":["webpack://./assets/styles/style.scss","webpack://./assets/styles/modules/_vars.scss"],"names":[],"mappings":"AAGA;EACE,SAAA;EACA,UAAA;EACA,sBAAA;AADF;;AAQA;EACE,gBAAA;EACA,mCAAA;AALF;;AAQA;EACE,0BAAA;EACA,iBAAA;AALF;;AAQA;EACE,2BAAA;EACA,eAAA;EACA,aAAA;EACA,6BAAA;EACA,qBAAA;EACA,eAAA;AALF;AAOE;EACE,yDAAA;EACA,wBAAA;EACA,cAAA;EACA,cAAA;AALJ;AASI;EACE,sBAAA;EACA,cAAA;EACA,cC1CM;ADmCZ;AAUI;EACE,cC9CM;ADsCZ;AAaI;EACE,sBAAA;EACA,gBAAA;EACA,iBAAA;AAXN;AAcI;EACE,kBAAA;EACA,sBAAA;EACA,qBAAA;EACA,cC7DM;ADiDZ;AAeI;EAEE,kBAAA;EACA,cAAA;EACA,WAAA;EACA,QAAA;EACA,gCAAA;EACA,yBAAA;AAdN;AAiBI;EACE,YAAA;EACA,OAAA;AAfN;AAkBI;EACE,eAAA;EACA,QAAA;AAhBN;AAmBI;EACE,YAAA;AAjBN;AAoBI;EACE,UAAA;AAlBN;;AAuBA;EACE,kBAAA;EACA,uCAAA;EACA,kBAAA;EACA,sDAAA;AApBF;;AAuBA;EACE;IACE,YAAA;IACA,uCAAA;EApBF;EAsBA;IACE,UAAA;IACA,uCAAA;EApBF;AACF;AAuBA;EACE;IACE,WAAA;IACA,aAAA;IACA,uBAAA;IACA,YAAA;EArBF;AACF;AAwBA;EACE;IACE,eAAA;EAtBF;EAwBA;IACE,WAAA;IACA,aAAA;IACA,uBAAA;IACA,YAAA;EAtBF;AACF;AAyBA;EACE;IACE,sBAAA;IACA,iBAAA;EAvBF;EA0BA;IACE,sBAAA;EAxBF;AACF","sourcesContent":["@use \"./modules/vars\";\n@import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;600;700;800;900&display=swap');\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n\n}\n\nhtml {\n  font-size: 62.5%;\n  font-family: 'Orbitron', sans-serif;\n}\n\na {\n  text-decoration-line: none;\n  font-size: 1.8rem;\n}\n\nheader {\n  background-color: aliceblue;\n  padding: 1.5rem;\n  display: flex;\n  justify-content: space-around;\n  align-items: flex-end;\n  flex-wrap: wrap;\n\n  #logo {\n    background-image: url(\"/assets/images/logo.png\");\n    background-size: contain;\n    width: 15.3rem;\n    height: 5.4rem;\n  }\n\n  #menu {\n    a {\n      padding: 0.5rem 1.5rem;\n      margin: 0 1rem;\n      color: vars.$font-blue;\n    }\n\n    a:hover {\n      color: vars.$font-blue;\n    }\n  }\n\n  #log {\n    a {\n      padding: 0.6rem 0.8rem;\n      margin: 0 0.5rem;\n      font-size: 1.4rem;\n    }\n\n    #login, #register {\n      position: relative;\n      box-sizing: border-box;\n      text-decoration: none;\n      color: vars.$font-blue;\n    }\n\n    #login::before, #login::after, #register::before, #register::after\n    {\n      position: absolute;\n      display: block;\n      content: \"\";\n      width: 0;\n      border-top: 0.2rem solid vars.$font-blue;\n      transition-duration: 0.5s;\n    }\n\n    #login::before, #register::before {\n      top: -0.2rem;\n      left: 0;\n    }\n\n    #login::after, #register::after {\n      bottom: -0.3rem;\n      right: 0;\n    }\n\n    #login:hover, #register:hover {\n      color: black;\n    }\n\n    #login:hover::before, #login:hover::after, #register:hover::before, #register:hover::after {\n      width: 75%;\n    }\n  }\n}\n\n#home:hover, #skills:hover , #application:hover , #contact:hover {\n  color: transparent;\n  text-shadow: 0.2rem 0.2rem 1rem vars.$font-blue;\n  text-align: center;\n  animation: flicker 0.5s ease-in-out infinite alternate;\n}\n\n@keyframes flicker {\n  0% {\n    opacity: 0.5;\n    text-shadow: 0.2rem 0.2rem 1rem vars.$font-blue;\n  }\n  100% {\n    opacity: 1;\n    text-shadow: 0.2rem 0.2rem 1rem vars.$font-blue;\n  }\n}\n\n@media screen and (max-width: 1050px) {\n  #log {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    margin: 1rem;\n  }\n}\n\n@media screen and (max-width: 805px){\n  header {\n    padding: 0.5rem;\n  }\n  #menu {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    margin: 1rem;\n  }\n}\n\n@media screen and (max-width: 600px){\n  header {\n    flex-direction: column;\n    flex-wrap: nowrap;\n  }\n\n  #menu {\n    flex-direction: column;\n  }\n}\n\n\n\n\n\n","$font-blue: #004aad;"],"sourceRoot":""}]);
// Exports
